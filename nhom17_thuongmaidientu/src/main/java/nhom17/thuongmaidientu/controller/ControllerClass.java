...
public class ControllerClass {
	...
	public String GetTrangCapNhatTT(Model model,HttpSession session)
	{	
		if(tkkh!=null)
		{
	...
	public String TrangQuanLyDonHang(Model modelKhachHang,Model modelHoaDon)
	{
		if(tkkh!=null)
		{
			...
			System.out.println(listHoaDon.get(0).getNgaydathang());
	...
	@RequestMapping("/trangtimkiemsanpham")
	...
	public String TrangQuanLyTaiKhoan(Model modelKhachHang,Model modelNhanvien,Model xacnhan)
	{
		if(tkkh!=null)
		{
	...
	public String Dieukhienthaydoimatkhau(@RequestParam String mkcu,@RequestParam String mkmoi,@RequestParam String mkxacnhan)
	{
		if(tkkh!=null)
		{
	...
	public String TrangQuanLySanPham(Model modelSanpham)
	{
		modelSanpham.addAttribute("sanpham", sanPhamRepository.findAll());	
	...
	public String DieuKhienThemSanPham()
	{
	...
	public String TrangQuanLyUuDai(Model modelUuDai,Model modelQuanTriVien)
	{
		if(quanTriVien!=null)
		{
	...
	public String TrangQuanLyKhachHang(Model modelKhachhang,Model modelQuantrivien)
	{
		if(quanTriVien!=null)
		{
			modelQuantrivien.addAttribute("tenquantrivien", quanTriVien.getTen());
	...
	public String TrangQuanLyNhanVien(Model modelQuantrivien,Model modelNhanvien)
	{
		if(quanTriVien!=null)
		{
			modelQuantrivien.addAttribute("tenquantrivien", quanTriVien.getTen());
	...
	public String TrangQuanLyVanChuyen(Model modelDonhang,Model modelNhanvien)
	{
		if(nhanVien!=null)
		{
	...
	public String DieuKhienTimKiemSanPham(@RequestParam String tensanpham,Model model)
	{
